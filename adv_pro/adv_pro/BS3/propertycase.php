            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">PROPERTY CASES</h4>
...
$sql = "SELECT id,name, email, date,time,case_type,status FROM appointment WHERE status='accept' and case_type='property'";
...
if ($result->num_rows > 0) {               
      ...
      while($row = $result->fetch_assoc()) {
        ...
        echo"<td><a href='acceptview2.php?id=" . $row['id'] . "'><button id=". $row['id'] .">view</button></a></td></tr>";
    }
    echo " </tbody>";
} else {
    echo "&nbspNo  Cases...!!!";
